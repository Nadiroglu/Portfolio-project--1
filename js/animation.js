...
const projectOne = document.querySelector(".pr-1")
const projectTwo = document.querySelector(".pr-2")
const projectThree = document.querySelector(".pr-3")
...
// Add an event listner to the window object to listen to resized events
...
// Store the last reverse animation which is ready to be played
...
function playAnimation (animation, reverseAnimation) {
    // do smth with these values inside of this code
...
tlBtn.onclick = function() {
    if (activeCorner === "top-left") {
        ...
        brContent.style.transform = brHidden;
        blContent.style.transform = blHidden;
        tlContent.style.transform = trActive;
    }
